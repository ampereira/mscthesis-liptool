...
DilepInput::DilepInput (TLorentzVector _z_lep, TLorentzVector _c_lep, TLorentzVector _z_bj, TLorentzVector _c_bj,
	...
	z_lep = new TLorentzVector (_z_lep);
	c_lep = new TLorentzVector (_c_lep);
	z_bj = new TLorentzVector (_z_bj);
	c_bj = new TLorentzVector (_c_bj);

	z_bjWFlags = new TLorentzVectorWFlags (_z_bjWFlags);
	c_bjWFlags = new TLorentzVectorWFlags (_c_bjWFlags);
	z_lepWFlags = new TLorentzVectorWFlags (_z_lepWFlags);
	c_lepWFlags = new TLorentzVectorWFlags (_c_lepWFlags);
...
DilepInput::DilepInput (DilepInput &other) {
	...
	z_lep = new TLorentzVector (other.getZlep());
	c_lep = new TLorentzVector (other.getClep());
	z_bj = new TLorentzVector (other.getZbj());
	c_bj = new TLorentzVector (other.getCbj());

	z_bjWFlags = new TLorentzVectorWFlags (other.getZbjW());
	c_bjWFlags = new TLorentzVectorWFlags (other.getCbjW());
	z_lepWFlags = new TLorentzVectorWFlags (other.getZlepW());
	c_lepWFlags = new TLorentzVectorWFlags (other.getClepW());
