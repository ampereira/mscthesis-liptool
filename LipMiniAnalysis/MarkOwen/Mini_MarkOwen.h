...
// Sat Nov 10 17:20:31 2012 by ROOT version 5.28/00
// from TTree mini/4-vectors + variables required for scaling factors
// found on file: user.tneep.011768._00001.merge.ML_7F.root
//////////////////////////////////////////////////////////
...
#ifdef Mini_Mark_cxx
Mini_Mark::Mini_Mark(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("user.tneep.011768._00001.merge.ML_7F.root");
      if (!f) {
         f = new TFile("user.tneep.011768._00001.merge.ML_7F.root");
      }
...
Int_t Mini_Mark::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Mini_Mark::LoadTree(Long64_t entry)
{
...
void Mini_Mark::Init(TTree *tree)
{
...
void Mini_Mark::Show(Long64_t entry)
{
...
Int_t Mini_Mark::Cut(Long64_t entry)
{
