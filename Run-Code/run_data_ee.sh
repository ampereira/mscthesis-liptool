...
################################################################################
cd ../AnalysisCode_dilep
time ttH_dilep --OutputFileName=ttHdilep_data_Egamma_ee_disc --SetSystematicsFileName=../RefSys/Ref.txt --isData=1 --User="alldata_ele=1" --User="CutTriggerEle=1" --User="lepSample=21"
cd ../Run-Code
################################################################################
