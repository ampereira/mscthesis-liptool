...
################################################################################
cd ../AnalysisCode_dilep
time ttH_dilep --OutputFileName=ttHdilep_data_Muon_em_disc --SetSystematicsFileName=../RefSys/Ref.txt --isData=1 --User="alldata_muo=1" --User="CutTriggerEle=0" --User="CutTriggerMuo=1" --User="lepSample=23"
cd ../Run-Code
################################################################################
